...
FieldMoist is a web-based system for generating daily farmland soil-moisture products at an effective spatial resolution of 100 m. The experiments and scientific validation reported in the manuscript were conducted using the complete two-year 2018-2019 dataset. Because the full raster archive is too large to distribute here and is subject to data-distribution constraints, this repository includes a representative 24-day subset for demonstrating the application workflow, including installation, processing, visualization, point analysis, and GeoTIFF export.

The representative subset provides 24 daily products from 2018-05-01 through 2018-05-24 for the **jiefangzha** display area (polygon 83). It also includes an offline `test` workflow for project 82 that can reproduce the **jiefangzha** display area.
